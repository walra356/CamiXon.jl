...
For given ``α = [α_0,⋯\ α_k]`` the *forward difference expansion weights*
are generated by the function [`fwd_diff_expansion_weights(α,Δ)`](@ref).
...
For given ``β = [β_0,⋯\ β_k]`` the *backward difference expansion weights*
are generated by the function [`bwd_diff_expansion_weights(β,∇)`](@ref),
