...
dictIsotopes = Dict(
        ...
        (23, 50) => ("V",  3.5800, 49947156.68,   6,   +1,    2.65e17, +3.3456889,    +0.21,      0.25),
        ...
        (26, 60) => ("Fe", 3.7800, 59934070.25,   0,   +1,    2.62e06, 0,             0,          nothing),
        (27, 59) => ("Co", 3.7875, 58933193.52,   7/2, -1,      1e100, +4.615,       +0.42,     100.00),
        (27, 60) => ("Co", 3.7900, 59933815.54,   5,   +1,    1925.28, +3.799,       +0.46,      nothing),
