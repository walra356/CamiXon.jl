...
function show_image(data, mul=1.0; inline=false, res=(900,600), footnote::String=" ", textsize=10, xcenter=false, ycenter=false)
...
function plot_matrix(data, mul=1.0; inline=false, res=(900,600), footnote::String=" ", textsize=10, xcenter=false, ycenter=false)
    ...
    (yticks,xticks) = set_ticks(data; xcenter=xcenter, ycenter=ycenter)
