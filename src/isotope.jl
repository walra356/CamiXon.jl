...
function _strIsotope(Z::Int, A::Int)
    ...
    str *= ", M=" * repr(isotope.M) * " amu"
    str *= ", I=" * strRational(isotope.I) * strπ * " ħ"
...
function _init_table(Z1::Int, Z2::Int)
    ...
    str = "\\begin{table}[H]"
    str *= "\\setlength{\\tabcolsep}{3pt}\\small"
    str *= "\\renewcommand{\\arraystretch}{1.25}"
    str *= "\\centering"
...
latexIsotopeTable(1:3)
  \begin{table}[H]\setlength{\tabcolsep}{3pt}\small\renewcommand{\arraystretch}{1.25}\centering
